    ...
    return <>
        <div className="min-h-screen w-full bg-[#F8FAFC]">
            <div className="w-full max-w-300 mx-auto p-4 md:px-6">
                <Card className="w-full bg-white border-[#E7EBF3] shadow-[0px_1px_2px_rgba(0,0,0,0.05)] rounded-2xl p-4 md:p-6">
                    <div className="p-0 grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-6 items-center md:items-start">
                        <div className="flex justify-center md:block">
                            <div className="w-24 h-24 rounded-full ring-4 ring-[#F9FAFB] bg-slate-200 overflow-hidden shrink-0">
                                <img src=".." alt="Sarah Ali" className="w-full h-full object-cover" />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1 text-center md:text-left">
                            <div className="flex flex-col sm:flex-row items-center gap-3">
                                <h1 className="font-['Inter'] font-bold text-[24px] text-[#0D121B] tracking-[-0.6px]">
                                    Sarah Ali
                                </h1>
                                <span className="bg-[#DBEAFE] text-[#2B6CEE] text-[10px] font-bold px-2 py-0.5 rounded-full tracking-[0.6px] uppercase">
                                    Active
                                </span>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-center gap-2 md:gap-4 text-[#4C669A] text-[14px] mt-2">
                                <span className="flex items-center justify-center md:justify-start gap-1.5">
                                    <Venus className="w-4 h-4" /> 34 Yrs
                                </span>
                                <span className="flex items-center justify-center md:justify-start gap-1.5">
                                    <span className="font-medium text-[12px]">ID:</span>
                                    <IdCard className="w-4 h-4" /> #PAT-8832
                                </span>
                                <span className="flex items-center justify-center md:justify-start gap-1.5 uppercase">
                                    <span className="font-medium text-[12px]">Blood:</span>
                                    <Droplets className="w-4 h-4" /> O+
                                </span>
                            </div>
                            <div className="flex flex-wrap justify-center md:justify-start gap-2 mt-4">
                                <div className="px-3 py-1 bg-[#F1F5F9] border border-[#F3F4F6] rounded-xl text-[12px] font-bold text-[#475569] uppercase">
                                    Asthma
                                </div>
                                <div className="px-3 py-1 bg-[#F1F5F9] border border-[#F3F4F6] rounded-xl text-[13px] font-semibold text-[#475569]">
                                    Penicillin Allergy
                                </div>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 md:flex md:flex-row gap-3 w-full md:w-auto">
                            <Button variant="outline" className="flex items-center justify-center gap-2 h-11 md:h-10 border-slate-200">
                                <Link href="/add-note" className="flex items-center">
                                    <NotepadText size={18} className="mr-2" />
                                    <span className="text-sm">Notes</span>
                                </Link>
                            </Button>
                            <Button className="flex items-center justify-center gap-2 h-11 md:h-10 bg-blue-600 hover:bg-blue-700 shadow-blue-500/20 shadow-lg">
                        ...
                        <div className="p-0">
                            <div className="flex items-start gap-3 p-4">
                                ...
                                <div className="flex flex-col gap-0.5">
                                    <span className="font-semibold text-[14px] leading-5 text-[#0F172A]">
                                        Type 2 Diabetes
                                    </span>
                                    <span className="text-[12px] leading-4 text-[#64748B]">
                                        Diagnosed: Nov 12, 2019
                                    </span>
                                    <div className="bg-[#FFFBEB] px-2 py-0.5 rounded-full w-fit mt-0.5">
                                        <span className="text-[10px] font-bold tracking-[0.25px] text-[#D97706] uppercase">
                                            Chronic
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-start gap-3 p-4 border-t border-[#F1F5F9]">
                                <div className="mt-1 shrink-0">
                                    <div className="w-8 h-8 bg-[#EFF6FF] rounded-lg flex items-center justify-center">
                                        <BriefcaseMedical className="w-5 h-6 text-[#2563EB]" />
                                    </div>
                            ...
                            <div className="flex items-start gap-3 p-4 border-t border-[#F1F5F9]">
                                <div className="mt-1 shrink-0">
                                    <div className="w-8 h-8 bg-[#EFF6FF] rounded-lg flex items-center justify-center">
                                        <Bandage className="w-5 h-6 text-[#2563EB]" />
                                    </div>
                                </div>
                                <div className="flex flex-col gap-0.5">
                                    <span className="font-semibold text-[14px] leading-5 text-[#0F172A]">
                                    ...
                                    <span className="text-[12px] leading-4 text-[#64748B]">
                                        Diagnosed: Jan 05, 2023
                                    </span>
                                    <div className="bg-[#F0FDF4] px-2 py-0.5 rounded-full w-fit mt-0.5">
                                        <span className="text-[10px] font-bold tracking-[0.25px] text-[#16A34A] uppercase">
                                            Resolved
                                        </span>
                                    </div>
                                </div>
